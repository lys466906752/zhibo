	...
	function add_admin()
	{
		if(form_loads==1)
		{
			...
			else
			{
				layer.closeAll();
				form_loads=2;	
				$.ajax({url:"<?php echo admin_url();?>home/adminInsert", 
				type: 'POST', 
...
?>
  <tr>
    <td height="60" colspan="2" align="left" valign="middle" style="padding-top:15px;"><h2>添加管理员</h2></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="83%" height="55" align="left" valign="middle"><input type="text" name="username" id="username" style="width:90%; height:28px; line-height:28px; padding-left:5px; padding-right:5px; border:#e4e4e4 1px solid; border-radius:3px;" placeholder="请输入管理员账号，必须字母开头" /></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="50" colspan="2" align="center" valign="middle"><input type="submit" name="button" id="button" value=" 添 加 管 理 员  " onclick="add_admin();" /></td>
        </tr>
      </table>
