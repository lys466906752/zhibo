	...
	function add_admin()
	{
		...
		if(form_loads==1)
		{
			...
			else
			{
				layer.closeAll();
				form_loads=2;	
				$.ajax({url:"<?php echo admin_url();?>members/updateUser/<?php echo $res['id'];?>", 
				type: 'POST', 
...
<table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="31%" height="55" align="center" valign="middle"><font color="#FF0000">*</font> 用户昵称：</td>
          <td width="69%" height="55" align="left" valign="middle"><input type="text" name="nickname" id="nickname" style="width:90%; height:28px; line-height:28px; padding-left:5px; padding-right:5px; border:#e4e4e4 1px solid; border-radius:3px;" value="<?php echo $res['nickname'];?>" placeholder="请为会员取一个昵称吧" /></td>
        </tr>
        <tr>
          <td height="55" align="center" valign="middle"><font color="#FF0000">*</font> 用户头像：</td>
        ...
        <tr>
          ...
          <td height="55" align="left" valign="middle"><input type="hidden" id="avatar" name="avatar" value="<?php echo $res['avatar'];?>" /><img src="/<?php echo $res['avatar'];?>" id="avatarsImg" width="65" height="65" /></td>
        </tr>
        <tr>
