	...
	function add_admin()
	{
		...
		if(form_loads==1)
		{
			...
			else
			{
				layer.closeAll();
				form_loads=2;	
				$.ajax({url:"<?php echo admin_url();?>projecteds/mvAddInser/<?php echo $res['id'];?>", 
				type: 'POST', 
  ...
  <tr>
    <td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="69%" height="55" align="left" valign="middle"><input type="text" name="nickname" id="nickname" style="width:90%; height:28px; line-height:28px; padding-left:5px; padding-right:5px; border:#e4e4e4 1px solid; border-radius:3px;" value="" placeholder="请为视频取一个标题名称吧" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="55" align="left" valign="middle"><input type="hidden" id="avatar" name="avatar" value="" /><img src="" id="avatarsImg" width="165" height="65" style="display:none;" /></td>
        </tr>
        <tr>
          <td height="55" align="center" valign="middle"><font color="#FF0000">* </font>视频ID：</td>
          <td height="55" align="left" valign="middle"><input type="text" name="mvId" id="mvId" style="width:90%; height:28px; line-height:28px; padding-left:5px; padding-right:5px; border:#e4e4e4 1px solid; border-radius:3px;" value="" placeholder="请填写视频地址" /></td>
        </tr>
        <tr>
          <td width="31%" height="55" align="center" valign="middle"><font color="#FF0000">*</font> AppId：</td>
          <td width="69%" height="55" align="left" valign="middle"><input type="text" name="appId" id="appId" style="width:90%; height:28px; line-height:28px; padding-left:5px; padding-right:5px; border:#e4e4e4 1px solid; border-radius:3px;" value="" placeholder="请填写视频地址" /></td>
        </tr>
        <tr>
